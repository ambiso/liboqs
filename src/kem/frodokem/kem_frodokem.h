...
OQS_API OQS_STATUS OQS_KEM_frodokem_640_aes_decaps_measure(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key, uint64_t *, uint64_t *, uint32_t *, uint32_t *, uint8_t *, uint8_t *);
OQS_API OQS_STATUS OQS_KEM_frodokem_640_aes_get_Eppp(const uint8_t *ciphertext, const uint8_t *secret_key, uint16_t *out);
#endif
...
OQS_API OQS_STATUS OQS_KEM_frodokem_640_shake_decaps_measure(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key, uint64_t *, uint64_t *, uint32_t *, uint32_t *, uint8_t *, uint8_t *);
OQS_API OQS_STATUS OQS_KEM_frodokem_640_shake_get_Eppp(const uint8_t *ciphertext, const uint8_t *secret_key, uint16_t *out);
#endif
...
OQS_API OQS_STATUS OQS_KEM_frodokem_976_aes_decaps_measure(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key, uint64_t *, uint64_t *, uint32_t *, uint32_t *, uint8_t *, uint8_t *);
OQS_API OQS_STATUS OQS_KEM_frodokem_976_aes_get_Eppp(const uint8_t *ciphertext, const uint8_t *secret_key, uint16_t *out);
#endif
...
OQS_API OQS_STATUS OQS_KEM_frodokem_976_shake_decaps_measure(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key, uint64_t *, uint64_t *, uint32_t *, uint32_t *, uint8_t *, uint8_t *);
OQS_API OQS_STATUS OQS_KEM_frodokem_976_shake_get_Eppp(const uint8_t *ciphertext, const uint8_t *secret_key, uint16_t *out);
#endif
...
OQS_API OQS_STATUS OQS_KEM_frodokem_1344_aes_decaps_measure(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key, uint64_t *, uint64_t *, uint32_t *, uint32_t *, uint8_t *, uint8_t *);
OQS_API OQS_STATUS OQS_KEM_frodokem_1344_aes_get_Eppp(const uint8_t *ciphertext, const uint8_t *secret_key, uint16_t *out);
#endif
...
OQS_API OQS_STATUS OQS_KEM_frodokem_1344_shake_decaps_measure(uint8_t *shared_secret, const uint8_t *ciphertext, const uint8_t *secret_key, uint64_t *, uint64_t *, uint32_t *, uint32_t *, uint8_t *, uint8_t *);
OQS_API OQS_STATUS OQS_KEM_frodokem_1344_shake_get_Eppp(const uint8_t *ciphertext, const uint8_t *secret_key, uint16_t *out);
#endif
