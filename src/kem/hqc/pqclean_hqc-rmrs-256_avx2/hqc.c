...
void PQCLEAN_HQCRMRS256_AVX2_hqc_pke_keygen(unsigned char *pk, unsigned char *sk) {
    ...
    // Compute secret key
    PQCLEAN_HQCRMRS256_AVX2_vect_set_random_fixed_weight(NULL, &sk_seedexpander, x, PARAM_OMEGA);
    PQCLEAN_HQCRMRS256_AVX2_vect_set_random_fixed_weight(NULL, &sk_seedexpander, y, PARAM_OMEGA);
...
void PQCLEAN_HQCRMRS256_AVX2_hqc_pke_encrypt(uint64_t *u, uint64_t *v, uint8_t *m, unsigned char *theta, const unsigned char *pk) {
    ...
    PQCLEAN_HQCRMRS256_AVX2_vect_set_random_fixed_weight(NULL, &seedexpander, r1, PARAM_OMEGA_R);
    PQCLEAN_HQCRMRS256_AVX2_vect_set_random_fixed_weight(NULL, &seedexpander, r2, PARAM_OMEGA_R);
    PQCLEAN_HQCRMRS256_AVX2_vect_set_random_fixed_weight(NULL, &seedexpander, e, PARAM_OMEGA_E);
