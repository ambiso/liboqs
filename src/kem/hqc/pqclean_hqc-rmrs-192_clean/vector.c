 ...
 */
void PQCLEAN_HQCRMRS192_CLEAN_vect_set_random_fixed_weight_by_coordinates(int *trace, AES_XOF_struct *ctx, uint32_t *v, uint16_t weight) {
 ...
 * @param[in] ctx Pointer to the context of the seed expander
 */
void PQCLEAN_HQCRMRS192_CLEAN_vect_set_random_fixed_weight(int * trace, AES_XOF_struct *ctx, uint64_t *v, uint16_t weight) {
    uint32_t tmp[PARAM_OMEGA_R] = {0};

    PQCLEAN_HQCRMRS192_CLEAN_vect_set_random_fixed_weight_by_coordinates(trace, ctx, tmp, weight);
