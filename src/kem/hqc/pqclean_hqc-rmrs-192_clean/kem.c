...
int PQCLEAN_HQCRMRS192_CLEAN_crypto_kem_numrejections(uint8_t m[VEC_K_SIZE_BYTES], size_t *seed_expanded_bytes) {
    ...
    PQCLEAN_HQCRMRS192_CLEAN_vect_set_random_fixed_weight(&trace, &seedexpander, r1, PARAM_OMEGA_R);
    PQCLEAN_HQCRMRS192_CLEAN_vect_set_random_fixed_weight_by_coordinates(&trace, &seedexpander, r2, PARAM_OMEGA_R);
    PQCLEAN_HQCRMRS192_CLEAN_vect_set_random_fixed_weight(&trace, &seedexpander, e, PARAM_OMEGA_E);
