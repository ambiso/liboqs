...
void PQCLEAN_HQCRMRS256_CLEAN_hqc_pke_encrypt(uint64_t *u, uint64_t *v, uint8_t *m, unsigned char *theta, const unsigned char *pk) {
    ...
    PQCLEAN_HQCRMRS256_CLEAN_vect_set_random_fixed_weight(NULL, &seedexpander, r1, PARAM_OMEGA_R);
    PQCLEAN_HQCRMRS256_CLEAN_vect_set_random_fixed_weight_by_coordinates(NULL, &seedexpander, r2, PARAM_OMEGA_R);
    PQCLEAN_HQCRMRS256_CLEAN_vect_set_random_fixed_weight(NULL, &seedexpander, e, PARAM_OMEGA_E);
...
void PQCLEAN_HQCRMRS256_CLEAN_hqc_pke_error_components(const unsigned char *m, uint64_t *r1, uint64_t *r2, uint64_t *e) {
    ...
    // Generate r1, r2 and e
    PQCLEAN_HQCRMRS256_CLEAN_vect_set_random_fixed_weight(NULL, &seedexpander, r1, PARAM_OMEGA_R);
    PQCLEAN_HQCRMRS256_CLEAN_vect_set_random_fixed_weight(NULL, &seedexpander, r2, PARAM_OMEGA_R);
    PQCLEAN_HQCRMRS256_CLEAN_vect_set_random_fixed_weight(NULL, &seedexpander, e, PARAM_OMEGA_E);
}
...
void PQCLEAN_HQCRMRS256_CLEAN_hqc_pke_decrypt_intermediates(uint8_t *m, uint8_t *rmencoded, uint8_t *rmdecoded, const uint64_t *u, const uint64_t *v, const unsigned char *sk) {
    ...
    PQCLEAN_HQCRMRS256_CLEAN_reed_muller_decode(tmpdecode, (uint8_t *)tmp1);
    memcpy(rmdecoded, tmpdecode, sizeof(tmpdecode));
    PQCLEAN_HQCRMRS256_CLEAN_reed_solomon_decode(m, tmpdecode);

    PQCLEAN_HQCRMRS256_CLEAN_reed_solomon_encode(tmpencode, m);
