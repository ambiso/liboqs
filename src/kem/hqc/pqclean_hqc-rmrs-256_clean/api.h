...
#define PQCLEAN_HQCRMRS256_CLEAN_CRYPTO_ALGNAME                      "HQC-RMRS-256"
...
int PQCLEAN_HQCRMRS256_CLEAN_crypto_kem_numrejections(unsigned char *m, unsigned long *seed_expanded_bytes);
