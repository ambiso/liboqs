...
OQS_API OQS_STATUS OQS_KEM_bike_l1_encaps_with_m(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *m);
...
OQS_API OQS_STATUS OQS_KEM_bike_l3_encaps_with_m(uint8_t *ciphertext, uint8_t *shared_secret, const uint8_t *public_key, const uint8_t *m);
